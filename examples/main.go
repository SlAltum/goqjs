...
import (
	...
	"github.com/slaltum/goqjs"
)

func check(err error) {
	if err != nil {
		var evalErr *goqjs.Error
...
func main() {
	...
	A := func(ctx *goqjs.Context, this goqjs.Value, args []goqjs.Value) goqjs.Value {
		fmt.Println("A got called!")
		return ctx.Null()
	}

	B := func(ctx *goqjs.Context, this goqjs.Value, args []goqjs.Value) goqjs.Value {
